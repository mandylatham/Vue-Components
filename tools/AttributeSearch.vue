    ...
    <div class="card card-accent-info card-compact">
        ...
        <div class="card-block pb-0 pt-0">
            <div v-for="col in columnAttributes" class="row">
                <div v-for="att in col.attributes" v-if="att.name !== 'cost' && att.name !== 'Cost'" v-bind:class="col.class + ' p-1'">
                    ...
                    <div class="input-group">
                        ...
                        <input v-if="att.type==='smallText'" type="text" v-bind:id="att.name+'_'+att.type" v-on:change="textValueChanged" />

                        <input v-else-if="att.type==='integer'" type="number" v-bind:id="att.name+'_'+att.type" v-on:change="textValueChanged" />
