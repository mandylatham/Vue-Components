<template>
    <div class="sidebar">
        <nav class="sidebar-nav open">
            ...
            <div v-for="route in this.$router.options.routes" class="p-0 m-0">
                <ul class="nav search-nav">
                    ...
                    <li v-for="childRoute in route.children"
                        ...
                        <router-link tag="a" :to="{name: childRoute.name}" class="nav-link">
                            <i v-bind:class="childRoute.meta == null || childRoute.meta.iconClass == null ? defaultRouteIconClasses : childRoute.meta.iconClass"></i>
                            {{childRoute.name }}
                        </router-link>
                    </li>
                </ul>
