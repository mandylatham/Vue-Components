<template>
    <header class="app-header navbar">
        ...
        <ul class="nav navbar-nav ml-auto">
            <li class="nav-item">
                <router-link exact :to="{name: 'Shopping Cart'}"><i class="fa fa-shopping-cart text-white font-lg"></i></router-link>
            </li>
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" style="right:0!important">
                    ...
                    <router-link tag="a" exact :to="{name: 'Shopping Cart'}" class="dropdown-item">
