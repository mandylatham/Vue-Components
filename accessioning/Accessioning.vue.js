...
module.exports = {
    ...
    methods:{
        ...
        setAccessionHistory: function(updated){
            ...
            specTypes.forEach(function(s){
                typeof countedSpecTypes.find(function(c){
                    return c.string === s}) === 'undefined' ? countedSpecTypes.push({string:s, count:1}) : countedSpecTypes.find(function(c){
        ...
        validateSave: function()
		{
			...
			var vm = this;
			this.accessionState.accession.specimens.forEach(function (s) {
			...
			if ((this.$validator.errorBag && this.$validator.errorBag.any()) || !this.client || !this.facility || !this.lab || !specimensValidate){
                var retVal = false;
            }else{
                var retVal = true;
        	}
