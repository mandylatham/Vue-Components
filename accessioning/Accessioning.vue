	...
	<div id="accessioningMain" class="container-fluid p-lg-1 p-md-0 p-sm-0">
        ...
        <div v-if="accessionState.loaded">
			<transition name="fade">
				<div v-if="accessionState.savedStatus === false" class="alert alert-danger">
					Failed to save
					<a href="#" class="close" data-dismiss="alert">&times;</a>
				</div>
				<div v-if="accessionState.savedStatus === true" class="alert alert-success" >
					Success to save
					<a href="#" class="close" data-dismiss="alert">&times;</a>
				</div>
			</transition>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="dropdown w-100 mt-1 btn-icon-vertical-text-middle">
                                                <button v-if="validateSave()" @click="checkValidate"
                                                ...
                                                <button v-if="!validateSave()" disabled
                                                        class="btn btn-info btn-sm dropdown-toggle w-100"
                                                        type="button"
                                                        id="saveAccessionDropdown"
                                                        aria-haspopup="true"
                                    ...
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <tr v-for="comment in accessionState.accession.customData.comments"
                                                ...
                                                v-bind:class="(comment === accessionState.editingComment ? 'bg-info' : '') + ' cursor-pointer'">
